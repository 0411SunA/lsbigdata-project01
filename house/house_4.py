...
# -----------------
# 원하는 변수로 회귀모델 만들어서 서브밋
# GrLivArea
#test 셋에 있는 집 퀄리티 불러오기
...
# 이상치 찾기 -> 2개 house_train.query("GrLivArea > 4500")
...
# f(x, y, z) = (x-1)^2 + (y-2)^2 + (z-4)^2 + 7 최소값과 최소값이 되는 자리
def my_f3(x):
