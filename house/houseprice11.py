...
svr_model = SVR()
param_grid_svr = {
    'kernel': ['linear', 'poly', 'rbf', 'sigmoid'],  # 다양한 커널 함수 사용 가능
...
y5_hat = best_svr_model.predict(train_x_scaled)
...
# 두 번째 층: GradientBoosting, Ridge, Lasso
...
pred_y_svr = best_svr_model.predict(test_x_scaled)
